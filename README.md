...
## v10 placement pass
- moved the chalkboard text block further right onto the board face
- made the chalkboard block slightly narrower and tighter
- moved the right-side sign text further left inside its frame


## v11 final placement tweaks
- moved the street sign slightly further right
- moved and tightened the chalkboard text block further right so it sits more centrally on the board face
- adjusted the chalkboard angle slightly to fit the board perspective better
- moved the right-side sign text slightly upward
- moved the lower middle plaque text a bit left


## v12
- removed the HTML text overlay from the zeppelin
- all other placement remains as in v11


## v13 annotated-placement pass
Used the user's marked areas as guides:
- chalkboard overlay enlarged and moved into the marked rectangle
- chalkboard rotation reduced to better match the board face
- right-side quote moved left/up into the marked rectangle
- zeppelin HTML text remains removed


## v14 mobile layout
Added a proper mobile version:
- mobile devices no longer use the desktop image-overlay layout
- readable portrait cards for brand, countdown, menu, colleague message, and plaque
- desktop version remains unchanged
- mobile timer uses the same live countdown logic
